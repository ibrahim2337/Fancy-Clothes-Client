            ...
            <div className="hero-content flex-col gap-10 lg:flex-row  lg:px-5">
              ...
              <div>
                <p className="py-6 border bg-[#bdf3ef] rounded-md p-5">
                  ...
                  producing garments that are aesthetically pleasing,
                  functional, and suitable for various occasions or purposes.
                  Fashion designers are responsible for conceptualizing and
                  creating new styles, trends, and collections.
                  <br />
                  <br />
                  Fashion design encompasses several stages, including research,
                  sketching, fabric selection, pattern-making, garment
                  construction, and presentation. Designers draw inspiration
                  from various sources such as art, culture, history, nature,
                  and current trends to develop unique and innovative designs.
                  They consider factors like color, texture, silhouette,
                  proportion, and functionality while creating their designs.
                  <br />
                  <br />
                  Fashion designers often work in teams, collaborating with
                  pattern-makers, seamstresses, and other professionals in the
                  industry to bring their designs to life. They may showcase
                  their creations through fashion shows, exhibitions, or retail
          ...
          <div className="hero-content flex-col gap-10 lg:flex-row-reverse lg:px-5">
            ...
            <div>
              <p className="py-6 border bg-[#bdf3ef] rounded-md p-5">
                ...
                process of creating original clothing and accessories. It
                combines artistic creativity with technical expertise to design
                garments that are visually appealing, functional, and reflective
                of current trends or personal styles. A fashion designer's goal
                is to create unique and innovative designs that resonate with
                consumers and make a statement in the fashion industry.
                <br />
                <br />
                The process of fashion design typically begins with extensive
                research and trend analysis. Designers explore various sources
                of inspiration, such as art, culture, nature, and historical
                ...
                details of the garments. These initial sketches serve as a
                visual representation of the designer's vision and serve as the
            ...
            <div className="hero-content flex-col gap-10 lg:flex-row  lg:px-5">
              ...
              <div>
                <p className="py-6 border bg-[#bdf3ef] rounded-md p-5">
                  ...
                  <br />
                  <br />
                  Fashion design is a dynamic and competitive field that
                  requires continuous innovation, adaptability to trends, and a
                  strong understanding of the fashion industry. Successful
                  fashion designers possess a keen eye for detail, a strong
                  sense of aesthetics, and a passion for creating unique and
                  wearable art.
                </p>
              </div>
            </div>
