...
const Classes = ({ img, _id, courseId, title, seats, instructor, price }) => {
  ...
  return (
    <>
      ...
      <div
        className={`col-span-12 lg:col-span-4 shadow-md border rounded-lg ${
      ...
      >
        ...
        <div className="px-6 py-4">
          ...
          <button
            ...
            className="w-full px-5 py-3 mt-5 rounded-md border-2 border-[#1EB2A6] text-[#1EB2A6] uppercase font-bold hover:bg-[#1EB2A6] hover:text-white"
          >
            Buy Now
          </button>
        </div>
